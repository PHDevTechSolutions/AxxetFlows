...
const ReportItem: React.FC = () => {
    ...
    const filteredAccounts = posts.filter((post) => {
        ...
        const isAvailable = post.DeliveryStatus.toLowerCase() === "delivered" || post.DeliveryStatus.toLowerCase() === "partially delivered";
                        ...
                        <div className="container mx-auto p-4">
                            <div className="grid grid-cols-1 md:grid-cols-1">
                                {showForm ? (
                                    ...
                                    <>
                                        <h2 className="text-lg font-bold mb-2">List of Delivered Orders</h2>
