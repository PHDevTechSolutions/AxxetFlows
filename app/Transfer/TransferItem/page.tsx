...
// Pages
import AddAccountForm from "../../../components/Transfer/Form";
import Table from "../../../components/Transfer/Table";
import SearchFilters from "../../../components/Transfer/SearchFilters";
...
const ReportItem: React.FC = () => {
    ...
    const fetchDatabase = async () => {
        try {
            const response = await fetch("/api/Transfer/FetchData");
    ...
    const filteredAccounts = posts.filter((post) => {
        const inSearchTerm =
            post.RequestedBy.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch(`/api/Transfer/DeleteData`, {
                method: "DELETE",
                headers: {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-1">
                                {showForm ? (
                                    ...
                                    <>
                                        ...
                                        <h2 className="text-lg font-bold mb-2">List of Transfers</h2>
